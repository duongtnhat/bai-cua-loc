                                        ...
                                        <div class="col-sm-12">
                                            <table class="table table-bordered dataTable table-striped" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%;">
                                                ...
                                                <tbody>
                                                    <%
                                                        Model.DBConnection();
                                                        ResultSet rs = Model.getData("select * from sc_bill");
                                                        while (rs.next()) {
                                                            String sql = "select sum(price * quatity) from sc_bill_detail as b join sc_product as p on b.pid = p.id where b.bid = ";
                                                            ResultSet tt = Model.getData(sql + rs.getString("id"));
                                                            tt.next();
                                                            int total = tt.getInt("");
                                                    %>
                                                    <tr role="row">
                                                        ...
                                                        <td>
                                                            <a href="./bill?bill=<%= rs.getString("id")%>" class="btn btn-success">
                                                                Detail
                                                            </a>
                                                        </td>
                                                    </tr>    
