                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <a class="btn btn-primary" href="./create" style="margin-bottom: 20px">
                                                Add product
                                            </a>
                                            <table class="table table-bordered dataTable table-striped" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%;">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr role="row">
                                                        <td>
                                                            <img src="<%= rs.getString("image")%>" style="max-width: 120px"/>
                                                        </td>
                                                        <td><%= rs.getString("name")%></td>
                                                        <td><%= rs.getString("price")%></td>
                                                        <td>
                                                            <a href="./product/delete?id=<%= rs.getString("id")%>" class="btn btn-danger" data-method="delete" rel="nofollow">
                                                                Delete
                                                            </a>
                                                        </td>
                                                    </tr>    
